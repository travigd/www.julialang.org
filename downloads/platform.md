...
If you want to launch Julia from the command line (within an already open terminal or in a script), run the following snippet from Terminal (not in the Julia prompt).
...
To launch Julia, open Terminal again, and simply execute the `julia` command.
